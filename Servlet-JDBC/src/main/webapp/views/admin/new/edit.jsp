...
<script>
    ...
    function addNew(data) {
        $.ajax({
            ...
            success: function (result) {
            	window.location.href = "${NewURL}?type=list&page=1&maxPageItem=2&sortName=title&sortBy=desc&message=insert_success";
            },
            error: function (error) {
            	window.location.href = "${NewURL}?type=list&page=1&maxPageItem=2&sortName=title&sortBy=desc&message=insert_fail";
            }
        });
    }
    function updateNew(data) {
        $.ajax({
            ...
            dataType: 'json',
            success: function (result) {
            	window.location.href = "${NewURL}?type=list&page=1&maxPageItem=2&sortName=title&sortBy=desc&message=update_success";
            },
            error: function (error) {
            	window.location.href = "${NewURL}?type=list&page=1&maxPageItem=2&sortName=title&sortBy=desc&message=update_fail";
            }
        });
    }
</script>
